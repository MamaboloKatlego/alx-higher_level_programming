...
/**
 * print_python_float - It prints out some basic info about Python lists.
 * Description: The function that prints some basic info about Python lists
...
/**
 * print_python_bytes - It prints the python bytes
 * Description: It prints python bytes
 * @p: The PyObject pointer
 * Return: It returns void.
 */
...
/**
 * print_python_list - It prints out some basic info about Python lists
 * Description: The function that prints some basic info about Python lists
 * @p: The PyObject pointer
 * Return: It returns void.
 */
